...
const Verpubli = (props) => {
          ...
          <div className="perfil-usuario-footer">
            <ul className="lista-datos">
              ...
              <div>
                ...
                <NavLink className="veterinary_link" to={'/veterinary/' + publication.veterinary._id + '/info'}>
                  Ver veterinario
                </NavLink>
              </div>
              ...
              <a className="lin" href={'https://wa.me/' + publication.veterinary.phone} target="_blank">
                {publication.veterinary.phone}
              </a>
            </ul>
          </div>
        </div>
  ...
  return <div>{publication !== null && <Publication />}</div>;
};
